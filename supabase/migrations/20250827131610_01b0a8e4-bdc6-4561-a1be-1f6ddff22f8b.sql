...
-- Create optimized indexes for performance (without CONCURRENTLY)
...
VALUES ('comprehensive_security_fix_completed', 1, 'counter', '{"timestamp": "' || NOW() || '", "policies_updated": 15, "indexes_optimized": 5}');