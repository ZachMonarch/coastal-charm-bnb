...
('Kitchen Renovation - Downtown Apartment', 'Complete kitchen renovation including new cabinets, countertops, and appliances', 'open', 'high', 'Renovation', ARRAY['Carpentry', 'Plumbing', 'Electrical'], 8000.00, 12000.00, 'Downtown District', (SELECT user_id FROM user_roles WHERE role = 'admin' LIMIT 1)),
('HVAC Maintenance - Office Complex', 'Quarterly HVAC system maintenance and inspection', 'in_progress', 'medium', 'Maintenance', ARRAY['HVAC', 'General Maintenance'], 500.00, 800.00, 'Business District', (SELECT user_id FROM user_roles WHERE role = 'admin' LIMIT 1)),
('Painting - Residential Property', 'Interior and exterior painting for 3-bedroom house', 'open', 'low', 'Maintenance', ARRAY['Painting', 'General Maintenance'], 2000.00, 3500.00, 'Residential Area', (SELECT user_id FROM user_roles WHERE role = 'admin' LIMIT 1));