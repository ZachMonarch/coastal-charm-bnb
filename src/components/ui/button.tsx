...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-sm hover:bg-primary-dark hover:shadow-md [&>a]:text-primary-foreground [&_a]:text-primary-foreground",
        destructive:
        ...
        hero: "bg-overlay/20 text-primary-foreground backdrop-blur-sm border border-white/30 hover:bg-overlay/30 shadow-lg hover:shadow-xl",
        heroSolid: "bg-primary text-primary-foreground shadow-lg hover:bg-primary-dark hover:shadow-xl hover:scale-[1.02] active:scale-[0.99]",
        ...
        gradient: "bg-gradient-to-r from-primary to-primary-dark text-primary-foreground shadow-md hover:shadow-lg hover:shadow-primary/30 hover:scale-[1.02] active:scale-[0.99]",
        glow: "bg-primary text-primary-foreground shadow-[0_0_20px_hsl(var(--primary)/0.3)] hover:bg-primary-dark hover:shadow-[0_0_30px_hsl(var(--primary)/0.5)] hover:scale-[1.02] active:scale-[0.99] transition-all duration-300",
        heroAction: "bg-black/70 text-primary-foreground border border-white/40 hover:bg-black/80 shadow-lg backdrop-blur-sm font-semibold",
        warning: "bg-warning text-warning-foreground shadow-sm hover:bg-warning/90 hover:shadow-md font-semibold",
      },
      size: {
