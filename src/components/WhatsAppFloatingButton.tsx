...
/**
 * WhatsApp Floating Button - Global contact widget
 * Links to business WhatsApp number: +1 (304) 365-8349
 */
  ...
  return (
    ...
    >
      ...
      <svg 
        ...
        viewBox="0 0 448 512" 
        className="h-7 w-7 md:h-8 md:w-8 text-white fill-current group-hover:animate-pulse"
      >
