...
export default function DashboardHeroWithImage({
  ...
  return (
    <div 
      className={cn("relative overflow-hidden rounded-2xl mb-8", className)}
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          ...
          loading="eager"
          onError={(e) => {
            e.currentTarget.src = '/placeholder-property.webp';
          }}
        />
      ...
      <div className="relative z-10 p-8 md:p-12">
        <div className="flex items-start gap-6">
          {Icon && (
            <div className="hidden md:flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-primary-dark shadow-lg shadow-primary/30 border-2 border-white/20">
      ...
      <div className="absolute bottom-4 left-1/2 w-48 h-24 bg-white/10 rounded-full blur-3xl" />
