        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none space-y-10">
          ...
          <section>
            ...
            <div className="not-prose flex flex-wrap gap-3 mt-6">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-medium hover:bg-primary/90"
                style={{ color: "hsl(0 0% 100%)", WebkitTextFillColor: "hsl(0 0% 100%)" }}
              >
