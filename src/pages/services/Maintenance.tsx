...
export default function Maintenance() {
  ...
  const processSteps = [
    { step: 1, title: "Report Issue", description: "Submit maintenance request online or call us", icon: <Phone className="h-6 w-6" /> },
    { step: 2, title: "Quick Response", description: "We assess and assign the right professional", icon: <Zap className="h-6 w-6" /> },
    { step: 3, title: "Expert Repair", description: "Licensed technician completes the work", icon: <Wrench className="h-6 w-6" /> },
    { step: 4, title: "Quality Check", description: "We verify the work meets our standards", icon: <ThumbsUp className="h-6 w-6" /> }
  ];

  const guarantees = [
    { icon: <Clock className="h-6 w-6" />, title: "Response Time", description: "30 min for emergencies" },
    { icon: <Shield className="h-6 w-6" />, title: "Licensed & Insured", description: "All technicians verified" },
    { icon: <Star className="h-6 w-6" />, title: "Satisfaction", description: "100% work guarantee" },
    { icon: <Sparkles className="h-6 w-6" />, title: "Transparent Pricing", description: "No hidden fees" }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
              {/* Connecting Line */}
              <div className="hidden md:block absolute top-12 left-0 right-0 h-1 bg-gradient-to-r from-amber-500 via-orange-500 to-emerald-500" style={{ marginLeft: '12%', marginRight: '12%' }} />
                ...
                >
                  <div className="relative inline-block mb-4">
                    <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${
                      ...
                      index === 1 ? 'from-orange-500 to-red-500' :
                      index === 2 ? 'from-red-500 to-rose-500' :
